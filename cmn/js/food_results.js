...
var select_url = "http://blue-healthcare.alere-wellnessportal.com/drugs/selectAllRestaurants";


$(document).ready(function(){
 	//$("#restaurants").addOption("none", "Select a Restaurant", true);
	//var optionValue="";
	//var optionText="";
	//$("#restaurants").addOption(optionValue, optionText, false);
	
	
	$.getJSON(select_url,
        function(data){

$("#restaurants").ajaxAddOption(select_url);
